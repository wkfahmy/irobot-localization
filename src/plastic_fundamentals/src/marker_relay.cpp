...
public:
    ...
    void mapMarker(const plastic_fundamentals::PublishMarker::Request &req)
    {
    ...
    void pointsMarker(const plastic_fundamentals::PublishMarker::Request &req)
    {
        visualization_msgs::Marker marker;
        marker.header.frame_id = "map";
        marker.header.stamp = ros::Time::now();
    ...
    void bezierMarker(const plastic_fundamentals::PublishMarker::Request &req)
    {
        visualization_msgs::Marker marker;
        marker.header.frame_id = "map";
        marker.header.stamp = ros::Time::now();
    ...
    void controlMarker(const plastic_fundamentals::PublishMarker::Request &req)
    {
        visualization_msgs::Marker marker;
        marker.header.frame_id = "map";
        marker.header.stamp = ros::Time::now();
        ...
        for (const plastic_fundamentals::Point& req_point : req.points) {
            geometry_msgs::Point pt;
            pt.x = req_point.x;
            pt.y = req_point.y;
            pt.z = 0.05;
    ...
    bool publishMarkerCallback(plastic_fundamentals::PublishMarker::Request &req,
        ...
        if (req.marker_type == "MapMarker") {
            mapMarker(req);
        }
        else if (req.marker_type == "PointsMarker") {
            pointsMarker(req);
        }
        else if (req.marker_type == "PointMarker") {
            pointMarker(req);
        }
        ...
        else if (req.marker_type == "BezierMarker") {
            bezierMarker(req);
        }
        else if (req.marker_type == "ControlMarker") {
            controlMarker(req);
        }
        else {
